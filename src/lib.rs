...
pub const TOKEN_METADATA_BASE_URL: &str = "https://ipfs.io/ipfs/QmZJr6m7phSyC6SEkh1iWpj4HLsz8Svyg2wvKu1REkBfK7";
...
#[init(contract = "ntf_market_test", event = "Cis2Event<ContractTokenId, ContractTokenAmount>")]
...
/// testing.
#[receive(contract = "ntf_market_test", name = "view", return_value = "ViewState")]
